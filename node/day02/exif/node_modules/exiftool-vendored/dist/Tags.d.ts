...
export interface Tags extends EXIFTags, ExifToolTags, FileTags, CompositeTags, MakerNotesTags, PrintIMTags, JFIFTags, APP12Tags, XMPTags, PhotoshopTags, FlashPixTags, ICC_ProfileTags, IPTCTags, MPFTags, APP1Tags, MetaTags, APP6Tags, APP14Tags, QuickTimeTags, RIFFTags, RAFTags, PanasonicRawTags, APP0Tags, ApplicationRecordTags {
    errors?: string[];
    Error?: string;
    Warning?: string;
    SourceFile?: string;
